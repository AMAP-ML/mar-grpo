...
DEVICE = "cuda"
MY_CONFIG_PATH=os.environ.get("GENEVAL_MMDET_CONFIG", "configs/mask2former/mask2former_swin-s-p4-w7-224_lsj_8x2_50e_coco.py")
...
def load_geneval():
    ...
    def load_models():
        ...
        clip_arch = "ViT-L-14"
        pretrained=os.environ.get('GENEVAL_CLIP_CKPT')
