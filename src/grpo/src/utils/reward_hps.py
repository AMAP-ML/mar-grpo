...
if __name__ == "__main__":
    ...
    ap.add_argument("--data_path", default=None, help="Folder containing metadata.jsonl")
    ap.add_argument("--image_path", default=None, help="Folder of images")
    ap.add_argument("--hps_ckpt_path", default=None)
    ap.add_argument("--clip_ckpt_path", default=None)
