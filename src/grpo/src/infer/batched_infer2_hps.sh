...
# EXP_NAME='t2i-r1-my-geneval-lr5e-6-test-datav3-kl_reweight2_hps_git_gdino'
...
SAVE_BASE="$WORKSPACE_ROOT/final_results/hps_gdino_git_reward/hps/${EXP_NAME}"
