...
run_name = "t2i-r1-nova-test-beta0.01_lr1e-6-test2-test2_sim"
qwen_path = "$CHECKPOINT_ROOT/BAAI/nova-d48w1024-sd512"
hf_dataset = "../../../data/geneval_and_t2i_data_final.json"
output_dir = f"$PROJECT_ROOT/workspace_t2i-r1_nova_new_ab/{run_name}"
...
# 添加 PYTHONPATH 环境变量
os.environ['WANDB_PROJECT']="nova_rl_new"
